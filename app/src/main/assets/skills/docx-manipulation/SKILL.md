...
from docx.shared import RGBColor               # NOTE: in python-docx, RGBColor IS in docx.shared (unlike python-pptx!)
from docx.enum.text import WD_ALIGN_PARAGRAPH  # LEFT, CENTER, RIGHT, JUSTIFY
from docx.enum.style import WD_STYLE_TYPE
from docx.enum.table import WD_TABLE_ALIGNMENT
from docx.enum.section import WD_ORIENT        # PORTRAIT, LANDSCAPE
from docx.oxml.ns import qn                    # for XML element manipulation
from docx.oxml import OxmlElement               # for page number fields etc.
```

> **NOTE**: In python-docx, `RGBColor` is in `docx.shared` (e.g. `from docx.shared import RGBColor`).
> This is DIFFERENT from python-pptx where `RGBColor` is in `pptx.dml.color`.
...
# Usage
set_cell_shading(table.cell(0, 0), '4472C4')  # blue header
